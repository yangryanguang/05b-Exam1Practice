...
def run_test_problem1a():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    expected = .8414709848 # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([6, 10], expected, test_results,
                                  format_string)
    actual = problem1a(0, 1)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 4:
    expected = 0.633210628e-1  # This is APPROXIMATELY the correct answer.
